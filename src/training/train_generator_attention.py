...
# MARATHON HYPERPARAMETERS (5-DAY RUN)
SEQ_LEN = 30         
BATCH_SIZE = 128     # Efficient for i7/GPU
EPOCHS = 30          # Run as many as possible until Saturday
HIDDEN_DIM = 512     
LAYERS = 2
...
class RAMEfficientDataset(Dataset):
    def __init__(self, text_file, word2vec, seq_len):
        ...
        print(f"   📊 Total Tokens: {total_words} (FULL DATASET LOADED)")
        ...
        print(f"   🚀 MODE: MARATHON (100% Data Coverage)")
...
def main():
    print("🚀 STARTING MARATHON TRAINING (Mon -> Sat)...")
    ...
    for epoch in range(EPOCHS):
        ...
        checkpoint_name = f"{SAVE_DIR}/god_mode_epoch_{epoch+1}.pth"
